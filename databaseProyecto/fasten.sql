...
INSERT INTO productos VALUES (DEFAULT,'A3SEDAN1.jpg','Audi A3 Sedán',('2021-01-29'),1,'El Audi A3 es un automóvil del segmento C producido por el fabricante alemán Audi desde 1996, abarcando 4 generaciones hasta el momento. Desde finales de verano de 2013 se ofrece también un A3 con carrocería sedán (o Limousine)​. Tiene 4.46 metros de largo, es decir casi 25 cm menos largo que un A4​.', DEFAULT, DEFAULT);
INSERT INTO productos VALUES (DEFAULT,'840_560.jpg','Audi S3',('2021-01-21'),2,'El motor 2.0 TFSI tiene una potencia de 310 CV y 400 Nm de par. De esta forma, el nuevo Audi S3 acelera de 0 a 100 km/h en solo 4,6 segundos y alcanza la velocidad máxima de 250 km/h. El Nuevo Audi S3 Sportback está equipado con una transmisión S tronic de siete velocidades.', DEFAULT, DEFAULT);
INSERT INTO productos VALUES (DEFAULT,'audi_a3.jpg ','Audi A3 Sportback',('2021-01-12'),3,'El Audi A3 es el compacto de la marca de los cuatro aros desde 1996, año en el que fue presentada la primera de sus ediciones. Es el precursor del segmento C premium, segmento que a día de hoy comparte con sus máximos rivales, también de origen alemán. A principios de 2020 se ha presentado la última de sus generaciones, la cuarta, con importantes cambios en todos los niveles.', DEFAULT, DEFAULT);
INSERT INTO productos VALUES (DEFAULT,'r8.jpg','Audi R8 V8',('2021-01-30'),4,'El Audi R8 se comercializa con un único propulsor, un V10 atmosférico de 5,2 litros, con lubricación por cárter seco e inyección directa. Se ofrece en dos versiones de potencia, 570 CV y 620 CV. Esta última versión corresponde al Audi R8 V10 Performance quattro, el modelo más potente de la gama R8.', DEFAULT, DEFAULT);
...
INSERT INTO productos VALUES (DEFAULT,'208.png','Peugeot',('2021-01-11'),6,'Vehículo dinámico y bien equilibrado. Equipado para hacer de tu viaje toda una experiencia: posee el nuevo i_Cockpit, caja automática de seis velocidades, dispositivo all-in-one con pantalla táctil, techo de cielo panorámico. Además, incorpora tecnologías de punta para mejorar su rendimiento, usabilidad y seguridad, como adaptación automática al entorno luminoso, mantenimiento línea de carril y alerta de descanso.', DEFAULT, DEFAULT);
INSERT INTO productos VALUES (DEFAULT,'corolla.jpg','Toyota Corolla',('2021-01-03'),7,'En esta generación 2020, ofrece muchas mejoras destacables: un diseño atractivo, un motor más potente (aunque también más eficiente), una nueva caja no-tan-CVT, un confort de marcha muy superior y un equipamiento de seguridad ejemplar (aunque sólo en las versiones SEG).', DEFAULT, DEFAULT);
...
INSERT INTO productos VALUES (DEFAULT,'mercedese63.jpg','Mercedes Benz E63 Amg',('2021-01-20'),10,'Motor naftero V8 4.0 biturbo, con 612 cv de potencia y 850 Nm de torque. Caja automática de nueve velocidades y tracción integral 4Matic+, que incluye distribución completa de torque (incluyendo tracción 100% trasera) y Drifting Mode (ver video abajo). Acelera de 0 a 100 km/h en 3,4 segundos y su velocidad máxima está limitada a 250 km/h.', DEFAULT, DEFAULT);
...
INSERT INTO comentarios VALUES (DEFAULT,('2021-01-09'),7,4,'aMe arrepenti, alto diseño','foto-1624296847283.JPG', DEFAULT, DEFAULT);
INSERT INTO comentarios VALUES (DEFAULT,('2021-01-10'),10,4,'Querria saber cuantos años de duracion tiene','foto-1624294509981.JPG', DEFAULT, DEFAULT);
...
INSERT INTO comentarios VALUES (DEFAULT,('2021-04-01'),5,6,'El auto de mis sueños','pilargonzales.jpg', DEFAULT, DEFAULT);
...
INSERT INTO comentarios VALUES (DEFAULT,('2021-04-01'),10,7,'El auto de mis sueños.','gretaThunberg.jpg', DEFAULT, DEFAULT);
